...
$(document).ready(function () {
  ...
  checkSubmitType(); //校正後の文章を１クリックでクリップボードにコピー

  $('#copy').on('click', function () {
    var $text = $('#after_rep > p').text();
    var $textarea = $('<textarea></textarea>');
    $textarea.text($text);
    $(this).append($textarea);
    $textarea.select();
    document.execCommand('copy');
    $textarea.remove(); //toastrプラグインを使ってトーストを表示
  ...
  $('#add').on('click', function () {
    $condition_number++;
    $('<input name="before_str' + $condition_number + '" type="text" value="" style="margin-right: 5px; ">' + '<i class="fas fa-arrow-right" style="width: 20px"></i>' + '<input name="after_str' + $condition_number + '" type="text" value="">' + '<br />').appendTo('#inputs');
...
__webpack_require__(/*! C:\vagrant\app_proofreading\auto-proof-reading\resources\js\app.js */"./resources/js/app.js");
__webpack_require__(/*! C:\vagrant\app_proofreading\auto-proof-reading\resources\sass\app.scss */"./resources/sass/app.scss");
module.exports = __webpack_require__(/*! C:\vagrant\app_proofreading\auto-proof-reading\resources\sass\test.scss */"./resources/sass/test.scss");
